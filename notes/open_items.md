...
- (Resolved 2026-06-28: `bronze/silver/gold_threshold` renamed to `star1/2/3_threshold` across code + `.tres` + `DESIGN_MODES.md`; star rating is now 1/2/3 stars, Trials keyed to rounds.)
